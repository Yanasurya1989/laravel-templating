...
<div class="container">
    <div class="tab-pane active" id="horizontal-form">
        <form action="/unit/store" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @if (session('errors'))
            ...
            <div class="mb-3 form-group">
                ...
                <input type="file" name="image" class="form-control1" accept="aplication/msword, application/pdf">
            </div>
