...
<div id="comment-1" class="comment">
    <div class="d-flex">
        <div class="comment-img"><img src="{{ asset('UpConstruction') }}/assets/img/blog/comments-1.jpg" alt="">
        </div>
        @foreach ($comment as $list)
            <div>
                <h5><a href="">{{$list->name}}</a> <a href="#" class="reply"><i class="bi bi-reply-fill"></i>
                        Reply</a></h5>
...
{{-- <div id="comment-2" class="comment">
    <div class="d-flex">
        <div class="comment-img"><img src="{{ asset('UpConstruction') }}/assets/img/blog/comments-2.jpg" alt="">
        </div>
        <div>
    ...
    <div id="comment-reply-1" class="comment comment-reply">
        <div class="d-flex">
            <div class="comment-img"><img src="{{ asset('UpConstruction') }}/assets/img/blog/comments-3.jpg"
                    alt=""></div>
            <div>
        ...
        <div id="comment-reply-2" class="comment comment-reply">
            <div class="d-flex">
                <div class="comment-img"><img src="{{ asset('UpConstruction') }}/assets/img/blog/comments-4.jpg"
                        alt=""></div>
                <div>
...
<div id="comment-3" class="comment">
    <div class="d-flex">
        <div class="comment-img"><img src="{{ asset('UpConstruction') }}/assets/img/blog/comments-5.jpg" alt="">
        </div>
        <div>
...
<div id="comment-4" class="comment">
    <div class="d-flex">
        <div class="comment-img"><img src="{{ asset('UpConstruction') }}/assets/img/blog/comments-6.jpg" alt="">
        </div>
        <div>
...
<div class="reply-form">
    ...
    <form action="/detilformthem/frontend/detil/comment" method="POST">
        @csrf
        <div class="row">
            <input type="hidden" value="{{ request()->route('id') }}" name="id_detil">
